    ...
    <div style={styles.fullScreen}>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.modeToggleRow}>
          <button onClick={() => { setEmailMode("signin"); setError(""); }} style={{ ...styles.modeTab, ...(emailMode === "signin" ? styles.modeTabActive : {}) }}>Sign In</button>
          <button onClick={() => { setEmailMode("signup"); setError(""); }} style={{ ...styles.modeTab, ...(emailMode === "signup" ? styles.modeTabActive : {}) }}>Create Account</button>
        </div>
        ...
        <p style={styles.footer}>
          By continuing, you agree to our <a href="/terms" style={styles.footerLink}>Terms</a> and <a href="/privacy" style={styles.footerLink}>Privacy Policy</a>.
        </p>
      </div>
    </div>
  );
...
const styles: Record<string, React.CSSProperties> = {
  ...
  card: { position: "relative", zIndex: 1, width: "100%", maxWidth: "400px", background: "#101010", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "16px", padding: "40px 36px 32px", boxShadow: "0 0 0 1px rgba(0,255,136,0.04), 0 24px 64px rgba(0,0,0,0.6)", animation: "fadeUp 0.4s ease both" },
  brand: { display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" },
  brandDot: { width: "10px", height: "10px", borderRadius: "50%", background: "#00ff88", flexShrink: 0, boxShadow: "0 0 10px #00ff88, 0 0 20px rgba(0,255,136,0.4)" },
  ...
  modeTab: { flex: 1, padding: "8px 12px", background: "transparent", border: "none", borderRadius: "6px", color: "rgba(235,235,235,0.45)", fontSize: "12px", fontFamily: "var(--font-space-mono), 'Space Mono', monospace", cursor: "pointer", transition: "background 0.15s ease, color 0.15s ease", letterSpacing: "0.3px" },
  ...
  eyeBtn: { position: "absolute", right: "10px", top: "50%", transform: "translateY(-50%)", background: "none", border: "none", color: "rgba(235,235,235,0.35)", cursor: "pointer", padding: "2px", display: "flex", alignItems: "center", justifyContent: "center" },
  ...
  submitBtn: { width: "100%", padding: "12px 16px", background: "#00ff88", border: "none", borderRadius: "8px", color: "#080808", fontSize: "13px", fontFamily: "var(--font-space-mono), 'Space Mono', monospace", fontWeight: 700, cursor: "pointer", transition: "opacity 0.15s ease", letterSpacing: "0.3px", marginBottom: "14px" },
